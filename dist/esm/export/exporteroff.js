...
export var ExporterOff = /*#__PURE__*/function (_ExporterBase) {
  _inherits(ExporterOff, _ExporterBase);

  var _super = _createSuper(ExporterOff);
  ...
  _createClass(ExporterOff, [{
    ...
    value: function ExportContent(exporterModel, format, files, onFinish) {
      var offFile = new ExportedFile('model.off');
      files.push(offFile);
      var offWriter = new TextWriter();
